      ...
      <div className="py-24 lg:py-40">
        <div className="container mx-auto px-6 lg:px-24">
          ...
          >
            ...
            >
              Let <span className="text-[#2BCC07]">IM Vision</span> help you
              elevate your brand with immersive{" "}
            ...
            >
              ...
              installation, support, long-term maintenance and monitoring —
              ensures a seamless experience that transforms spaces, elevates
              brands, and creates lasting impressions.
            </motion.p>
          </motion.div>
